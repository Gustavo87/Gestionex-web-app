...
$resultadoNombre = mysqli_query($con,"Select nombre_empresa from empresa where id =".$id_empresa);  	
$nombre = "";
...
$html= $html.'<tr>';
$html= $html.'	<td WIDTH="75px" ALIGN="CENTER" bgcolor="#FF0000">';
$html= $html. '		<font face="arial" size="10px" color="#ffffff">Actividad</font>';
$html= $html.'	</td>';
$html= $html.'	<td  WIDTH="100px" ALIGN="CENTER" bgcolor="#FF0000">';
$html= $html.'		<font face="arial" size="10px" color="#ffffff">Fecha Inicio</font>';
$html= $html.'	</td>';
$html= $html.'	<td WIDTH="100px" ALIGN="CENTER" bgcolor="#FF0000">';
$html= $html. '		<font face="arial" size="10px" color="#ffffff">Fecha Fin</font>';
$html= $html.'	</td>';
$html= $html.'	<td WIDTH="47px" ALIGN="CENTER" bgcolor="#FF0000">';
$html= $html. '		<font face="arial" size="10px" color="#ffffff">Durac.</font>';
$html= $html.'	</td>';
$html= $html.'	<td WIDTH="80px" ALIGN="CENTER" bgcolor="#FF0000">';
$html= $html. '		<font face="arial" size="10px" color="#ffffff">Distan.</font>';
$html= $html.'	</td>';
$html= $html.'	<td WIDTH="50px" ALIGN="CENTER" bgcolor="#FF0000">';
$html= $html. '		<font face="arial" size="10px" color="#ffffff">Ton.</font>';
$html= $html.'	</td>';
$html= $html.'	<td WIDTH="300px" ALIGN="CENTER" bgcolor="#FF0000">';
$html= $html. '		<font face="arial" size="10px" color="#ffffff">Lugar</font>';
$html= $html.'	</td>';
$html= $html.'</tr>';
...
while ($registro = mysqli_fetch_array($result)){  
  //$id = $registro['id'];
	$html= $html.'<tr>';
	$html= $html.'	<td WIDTH="75px" ALIGN="CENTER" >';
	$html= $html. '		<font face="arial" size="8px" >'.$registro['Actividad'].'</font>';
	$html= $html.'	</td>';
	$html= $html.'	<td  WIDTH="100px" ALIGN="CENTER" >';
	...
	$html= $html.'		<font>'. $fecha_inicio_formateada .'</font>'; //Fecha fin, sin segundos
	$html= $html.'	</td>';
	$html= $html.'	<td WIDTH="100px" ALIGN="CENTER" >';
	$html= $html. '		<font>'. $fecha_fin_formateada .'</font>'; //Fecha inicio, sin segundos
	$html= $html.'	</td>';
	$html= $html.'	<td WIDTH="47px" ALIGN="CENTER" >';
	$html= $html. '		<font>'. $registro['Duracion'] .'</font>'; // Horas
	$html= $html.'	</td>';
	$html= $html.'	<td WIDTH="80px" ALIGN="CENTER" >';
	$html= $html. '		<font>'. $registro['distancia'] .'</font>'; // Distancia: 8 caracteres + m
	$html= $html.'	</td>';
	$html= $html.'	<td WIDTH="50px" ALIGN="CENTER" >';
	$html= $html. '		<font>'. $registro['toneladas'] .'</font>'; // Toneladas: 8 caracteres
	$html= $html.'	</td>';
	$html= $html.'	<td WIDTH="300px" ALIGN="CENTER" >';
	$html= $html. '		<font face="arial" size="8px">'. $registro['lugar'] .' </font>'; //Lugar: 55 caracteres
	$html= $html.'	</td>';
	$html= $html.'</tr>';  
}  
